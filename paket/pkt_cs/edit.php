               ...
               <div class="card-body">
                  <form action="" method="post" class="form-input">
                     ...
                     <div class="form-grup">
                        ...
                        <input type="text" name="nama_cs" placeholder="Nama paket" value="<?= $data_cs['nama_cs'] ?>"
                           autocomplete="off" id="nama" required>
                     </div>

                     <div class="form-grup">
                        <label for="wk">Waktu Kerja</label>
                        <input type="text" name="waktu_kerja_cs" placeholder="Durasi Kerja"
                           value="<?= $data_cs['waktu_kerja_cs'] ?>" autocomplete="off" id="wk" required>
                     </div>

                     <div class="form-grup">
                        <label for="berat">Berat Min (Kg)</label>
                        <input type="text" name="kuantitas_cs" placeholder="Berat per-Kg"
                           value="<?= $data_cs['kuantitas_cs'] ?>" autocomplete="off" id="berat" required>
                     </div>

                     <div class="form-grup">
                        <label for="tarif">Tarif</label>
                        <input type="text" name="tarif_cs" placeholder="Harga Paket" value="<?= $data_cs['tarif_cs'] ?>"
                           autocomplete="off" id="tarif" required>
                     </div>

                     <div class="form-grup">
                        <label for="ket_cs">Keterangan</label>
                        <input type="text" name="keterangan_cs" value="<?= $data_cs['keterangan_cs'] ?>"
                           placeholder="Keterangan (optional)" autocomplete="off" id="ket_cs">
                     </div>
